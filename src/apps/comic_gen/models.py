...
class Scene(BaseModel):
    ...
    image_prompt: Optional[str] = Field(None, description="Saved prompt used for scene image generation")
    ...
    selected_video_id: Optional[str] = Field(None, description="ID of the selected scene motion-reference video")
...
class Prop(BaseModel):
    ...
    image_prompt: Optional[str] = Field(None, description="Saved prompt used for prop image generation")
    video_url: Optional[str] = None
    ...
    selected_video_id: Optional[str] = Field(None, description="ID of the selected prop motion-reference video")
    video_prompt: Optional[str] = Field(None, description="Prompt used for video generation")
