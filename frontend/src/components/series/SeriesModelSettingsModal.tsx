                ...
                >
                    ...
                    <div className="flex justify-end gap-3 p-5 border-t border-glass-border bg-surface">
                        ...
                        <button
                            ...
                            aria-busy={isSaving}
                            className="flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-foreground text-sm font-medium rounded-lg transition-[border-color,box-shadow] disabled:opacity-50"
                        >
