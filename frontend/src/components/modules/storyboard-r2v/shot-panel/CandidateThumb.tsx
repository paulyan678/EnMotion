...
export default function CandidateThumb({
    ...
    const localizedStatus = status === "pending"
        ? t("statusPending")
        : status === "processing"
            ? t("statusProcessing")
            : status === "failed"
        ...
        <div className="flex w-full flex-col gap-1">
            <div
                ...
                aria-label={t("candidateAria", {
                    ...
                    starred: task.is_starred ? t("candidateAriaStarred") : "",
                    label: task.label ? t("candidateAriaLabel", { label: task.label }) : "",
                })}
            ...
            >
                    ...
                    <div className="grid h-full w-full place-items-center">
                        {isProcessing ? (
                            <PendingTaskAffordance
                                statusLabel={status === "pending" ? t("queued") : t("generatingVideo")}
                                taskId={task.id}
                                compact
                ...
                {onSetActive && isCompleted ? (
                    <button
                        ...
                        aria-label={isActive ? t("activeTakeKeepPinned") : t("setActiveTake")}
                        onClick={(e) => {
                            e.stopPropagation();
                ...
                >
                    {task.label ? (
                        ...
                        <>
                            ...
                            <span className="text-text-muted italic">{t("addLabel")}</span>
                        </>
                    )}
                </button>
            )}
