...
function formatUploadError(err: T2IUploadError, t: ReturnType<typeof useTranslations>, locale: string): string {
    ...
    return detail && locale !== "zh" ? `${base} (${detail})` : base;
}
            ...
            <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:gap-5">
                ...
                <div className="relative grid h-[88px] w-[120px] shrink-0 place-items-center overflow-hidden rounded-md border border-glass-border bg-black/40">
                    {generating ? (
                        <PendingTaskAffordance
                            statusLabel={inFlightStatus === "pending" ? t("queued") : t("generatingVideo")}
                ...
                <div className="min-w-0 flex-1 space-y-1.5">
                    ...
                    {uploadError ? (
                        ...
                        >
                            {formatUploadError(uploadError, t, locale)}
                        </p>
                    ) : null}
                </div>
            </div>
                ...
                <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
                    {showStoryboardThumb ? (
                        <ThumbButton
                            ...
                            onHover={() => { /* noop */ }}
                            badge="storyboard"
                            ariaLabel={t("t2iStoryboardActiveAria")}
                    ...
                    {imageUrls.map((url, idx) => {
                        ...
                        return (
                            <ThumbButton
                                ...
                                ariaLabel={t("t2iCandidateAria", {
                                    number: idx + 1,
                                    active: active ? t("t2iCandidateActiveSuffix") : "",
                                })}
                                title={active ? t("t2iActiveRemove") : t("t2iMakeActive")}
                            />
                        );
                    })}
                </div>
