...
function PreviousEpisodeSummaryForScript({ scriptId }: PreviousEpisodeSummaryProps) {
    ...
    const handleGenerateHook = async () => {
        ...
        try {
            ...
            setError(locale === "zh" ? t("generateFailed") : (err?.response?.data?.detail || err?.message || t("generateFailed")));
        } finally {
                            ...
                            <NextHookSection
                                ...
                                onSave={async () => {
                                    ...
                                    try {
                                        ...
                                        setError(locale === "zh" ? t("saveFailed") : (err?.response?.data?.detail || err?.message || t("saveFailed")));
