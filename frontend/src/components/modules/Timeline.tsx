        ...
        <div className="h-64 bg-surface border-t border-glass-border flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-2 space-y-1 relative">
                ...
                <div className="h-16 bg-glass rounded-lg relative overflow-hidden group">
                    <div className="absolute inset-0 flex items-center px-2 text-xs font-medium text-text-muted pointer-events-none">{t("videoTrack")}</div>
                ...
                <div className="h-12 bg-glass rounded-lg relative overflow-hidden">
                    <div className="absolute inset-0 flex items-center px-2 text-xs font-medium text-text-muted pointer-events-none">{t("audioTrack")}</div>
