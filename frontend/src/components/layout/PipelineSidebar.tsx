                        ...
                        >
                            ...
                            <div className="flex flex-col items-start gap-0.5 text-sm flex-1 min-w-0">
                                ...
                                <span className="flex items-center gap-1.5 font-mono text-[9px] tracking-[0.12em] text-text-muted">
                                    <span>{tp("stepIndex", { number: index + 1 })}</span>
                                    {step.statusLabel ? (
                                        <>
                            ...
                            {isActive ? (
                                ...
                                <Lock size={13} className="ml-auto shrink-0 text-text-muted" aria-label={tp("gatedTooltip")} />
                            ) : step.status === "ready" ? (
                                ...
                                <span
                                    ...
                                    className={clsx(
                                        ...
                                        step.status === "idle" && "border-[1.5px] border-text-muted",
                                    )}
                                />
                            ) : null}
                        </button>
