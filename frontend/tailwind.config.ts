  ...
  theme: {
    extend: {
      colors: {
        ...
        danger: "var(--color-status-failed-fg)",
        ...
        "status-error-fg": "var(--color-status-failed-fg)",
        "status-error-border": "var(--color-status-failed-border)",
        "status-error-bg": "var(--color-status-failed-bg)",
      ...
      fontFamily: {
        ...
        display: ["var(--font-display)", "var(--font-space-grotesk)", "system-ui", "sans-serif"],
      },
      fontSize: {
